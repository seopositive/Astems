...
<body>
    <div id="wrap" class="card-body">
    	<aside>
    		<%=logid %>님 접속중!! &nbsp;&nbsp;
    		<a href="logoutctrl.do"><button class="btn btn-secondary">로그아웃</button></a>
    	</aside>    
        <header>
            <h1>글목록 보기</h1>
        </header>
...
%>		
					<tr>
						...
						<td width="100"><%=board.getTitle() %> </td>
						<td width="200"><%=board.getWriter() %></td>
						<td width="150"><%=board.getDay() %></td>
					</tr>
<%
	}
%>  --%>					
